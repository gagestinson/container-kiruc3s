...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kiruc3s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kiruc3s.containers.anotherwebservice.com/
...
```
git clone git@github.com:gagestinson/container-kiruc3s.git
cd container-kiruc3s
```
...
```
docker attach container-kiruc3s
```
